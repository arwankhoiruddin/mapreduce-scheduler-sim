...
set ylabel "Start Time/ms"

plot "TT.dat" u 1:($6) with points ls 2 title 'RR-RR', "TS.dat" u 1:($6) with points ls 3 title 'RR-FCFS', "SS.dat" u 1:($6) with points ls 1 title 'FCFS-FCFS', "ST.dat" u 1:($6) with points ls 4 title 'FCFS-RR'
