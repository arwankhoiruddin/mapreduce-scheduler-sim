...
//import pt.inesc_id.gsd.cloud2sim.serializer.CloudletSchedulerXmlSerializer;
//import pt.inesc_id.gsd.cloud2sim.serializer.CloudletXmlSerializer;
//import pt.inesc_id.gsd.cloud2sim.serializer.DatacenterXmlSerializer;
//import pt.inesc_id.gsd.cloud2sim.serializer.HostXmlSerializer;
//import pt.inesc_id.gsd.cloud2sim.serializer.VmXmlSerializer;
...
public class HazelSimCore {
    ...
    protected HazelSimCore() {
        System.out.println("HazelSimCore");
...
//        // wait for all executions to come alive
        cfg.setProperty("compatibility.initial.min.cluster.size", String.valueOf(Cloud2SimConstants.NO_OF_PARALLEL_EXECUTIONS));
        cfg.setProperty("compatibility.operation.call.timeout.millis", "50000000");
    }
