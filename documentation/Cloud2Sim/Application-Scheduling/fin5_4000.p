...
plot "SS.dat" u 1:($7) with points ls 1 title 'Finish Time (FCFS-FCFS)', "TT.dat" u 1:($7) with points ls 2 title 'Finish Time (RR-RR)', "TS.dat" u 1:($7) with points ls 3 title 'Finish Time (RR-FCFS)', "ST.dat"  u 1:($7) with points ls 4 title 'Finish Time (FCFS-RR)'
