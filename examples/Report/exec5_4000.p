...
set output "exec5_4000.png"

set xlabel "Cloudlet ID"
set ylabel "Execution Time/ms"

plot "SS.dat" u 1:($5) with points ls 1 title 'FCFS-FCFS', "TT.dat" u 1:($5) with points ls 2 title 'RR-RR', "TS.dat" u 1:($5) with points ls 3 title 'RR-FCFS', "ST.dat"  u 1:($5) with points ls 4 title 'FCFS-RR'
